...
public class SimpleConnectionTest {
	...
	public static class OfTest {
		...
		public void codeCoverage() {
			...
			Assert.assertEquals(node1, conn.origin());
			Assert.assertEquals(node2, conn.destination());
			Assert.assertEquals(cost, conn.cost());
			Assert.assertEquals(type, conn.connectionType());
		}
	}
