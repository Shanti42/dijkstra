...
public final class Cost<T extends Addable> implements Comparable {
     ...
     * @throws IllegalArgumentException if the input type is not correct
     */
    ...
    /**
     * Check whether this cost is equal to an input by internalValue
     * <p>
     * Autogenerated by IntelliJ
     *
     * @param o the input object to compare
     * @return true if the input is an instance of Cost and this cost has the same internalValue as the input, otherwise return false
     */
    @Override
