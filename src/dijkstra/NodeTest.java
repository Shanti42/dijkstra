...
public class NodeTest {
    ...
    public static class AvailableConnectionTest {
        ...
        public void branchCoverageOneParam() {
            ...
            assertTrue(node1.availableConnections(cost).contains(connection));
        }

        // bad data, with 1 parameter
        @Test(expected = NullPointerException.class)
        public void badDataOneParamCost() {
            node1.availableConnections((Cost) null);
        }

        // bad data, with 1 parameter
        @Test(expected = NullPointerException.class)
        public void badDataOneParamConnection() {
            node1.availableConnections((ConnectionType) null);
        }
